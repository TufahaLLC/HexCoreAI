...
function Participants({ rawInfo }) {
    ...
    const rows = list.map((p)=>{
        ...
        return {
            key: puuid ?? `${championName}-${summonerName}`,
            summonerName,
            championName,
            kills,
            deaths,
...
function Home() {
    const [gameName, setGameName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [rawById, setRawById] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
        ...
        try {
            ...
            if (Array.isArray(data?.matches)) {
                ...
                const rows = data.matches.map((m)=>{
                    ...
                    const gameStart = typeof info?.gameStartTimestamp === "number" ? info.gameStartTimestamp : typeof info?.gameCreation === "number" ? info.gameCreation : undefined;
                    const durationSeconds = typeof info?.gameDuration === "number" ? info.gameDuration : undefined;
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            children: matches.map((m)=>{
                                                ...
                                                const dur = typeof m.durationSeconds === "number" ? `${Math.floor(m.durationSeconds / 60)}m ${Math.floor(m.durationSeconds % 60)}s` : "-";
                                                const queueLabel = typeof m.queueId === "number" ? `${QUEUE_NAMES[m.queueId] ?? "Unknown"} (${m.queueId})` : "-";
                                                const isExpanded = expandedId === m.matchId;
                                                const raw = rawById[m.matchId];
                                                const info = raw?.info ?? {};
                                                const mapId = typeof info?.mapId === "number" ? info.mapId : undefined;
                                                const mapName = typeof mapId === "number" ? MAP_NAMES[mapId] ?? `Map ${mapId}` : "-";
                                                const gameMode = typeof info?.gameMode === "string" ? info.gameMode : "-";
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Participants, {
                                                                            rawInfo: info
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/page.tsx",
                                                                            lineNumber: 319,
