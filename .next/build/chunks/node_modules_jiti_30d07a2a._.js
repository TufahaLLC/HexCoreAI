...
(()=>{
    ...
    (()=>{
        ...
        let r = __turbopack_context__.r("[externals]/node:os [external] (node:os, cjs)");
        var n, a = [
            509,
            0,
            227,
            ...
            6,
            4191
        ], h = "\xaa\xb5\xba\xc0-\xd6\xd8-\xf6\xf8-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-ࢎࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೝೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲊᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꟍꟐꟑꟓꟕ-Ƛꟲ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ", c = {
            3: "abstract boolean byte char class double enum export extends final float goto implements import int interface long native package private protected public short static super synchronized throws transient volatile",
            5: "class enum extends super const export import",
            6: "enum",
            strict: "implements interface let package private protected public static yield",
            strictBind: "eval arguments"
        }, p = "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this", l = {
            5: p,
            "5module": p + " export import",
            6: p + " const class extends export import super"
        }, u = /^in(stanceof)?$/, d = RegExp("[" + h + "]"), f = RegExp("[" + h + "‌‍\xb7̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛ࢗ-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ೳഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-໎໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-ᫎᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‌‍‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯・꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿･]");
        function isInAstralSet(e, t) {
            for(var i = 65536, s = 0; s < t.length && !((i += t[s]) > e); s += 2)if ((i += t[s + 1]) >= e) return !0;
            return !1;
        }
        function isIdentifierStart(e, t) {
            return e < 65 ? 36 === e : e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && d.test(String.fromCharCode(e)) : !1 !== t && isInAstralSet(e, o)));
        }
        function isIdentifierChar(e, t) {
            return e < 48 ? 36 === e : e < 58 || !(e < 65) && (e < 91 || (e < 97 ? 95 === e : e < 123 || (e <= 65535 ? e >= 170 && f.test(String.fromCharCode(e)) : !1 !== t && (isInAstralSet(e, o) || isInAstralSet(e, a)))));
        }
        ...
        function kw(e, t) {
            return void 0 === t && (t = {}), t.keyword = e, _[e] = new acorn_TokenType(e, t);
        }
        var x = {
            num: new acorn_TokenType("num", g),
            regexp: new acorn_TokenType("regexp", g),
            string: new acorn_TokenType("string", g),
            name: new acorn_TokenType("name", g),
            privateId: new acorn_TokenType("privateId", g),
            ...
            comma: new acorn_TokenType(",", m),
            semi: new acorn_TokenType(";", m),
            colon: new acorn_TokenType(":", m),
            dot: new acorn_TokenType("."),
            question: new acorn_TokenType("?", m),
            questionDot: new acorn_TokenType("?."),
            arrow: new acorn_TokenType("=>", m),
            template: new acorn_TokenType("template"),
            invalidTemplate: new acorn_TokenType("invalidTemplate"),
            ellipsis: new acorn_TokenType("...", m),
            backQuote: new acorn_TokenType("`", g),
        ...
        function getOptions(e) {
            var t = {};
            for(var i in P)t[i] = e && w(e, i) ? e[i] : P[i];
            if ("latest" === t.ecmaVersion ? t.ecmaVersion = 1e8 : null == t.ecmaVersion ? (!A && "object" == typeof console && console.warn && (A = !0, console.warn("Since Acorn 8.0.0, options.ecmaVersion is required.\nDefaulting to 2020, but this will stop working in the future.")), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), null == t.allowReserved && (t.allowReserved = t.ecmaVersion < 5), e && null != e.allowHashBang || (t.allowHashBang = t.ecmaVersion >= 14), T(t.onToken)) {
                var s = t.onToken;
                t.onToken = function(e) {
                    return s.push(e);
                };
            }
            return T(t.onComment) && (t.onComment = pushComment(t, t.onComment)), t;
        }
        ...
        var acorn_Parser = function(e, t, i) {
            this.options = e = getOptions(e), this.sourceFile = e.sourceFile, this.keywords = wordsRegexp(l[e.ecmaVersion >= 6 ? 6 : "module" === e.sourceType ? "5module" : 5]);
            var s = "";
            !0 !== e.allowReserved && (s = c[e.ecmaVersion >= 6 ? 6 : 5 === e.ecmaVersion ? 5 : 3], "module" === e.sourceType && (s += " await")), this.reservedWords = wordsRegexp(s);
            var r = (s ? s + " " : "") + c.strict;
            this.reservedWordsStrict = wordsRegexp(r), this.reservedWordsStrictBind = wordsRegexp(r + " " + c.strictBind), this.input = String(t), this.containsEsc = !1, i ? (this.pos = i, this.lineStart = this.input.lastIndexOf("\n", i - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(v).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = x.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = "module" === e.sourceType, this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = Object.create(null), 0 === this.pos && e.allowHashBang && "#!" === this.input.slice(0, 2) && this.skipLineComment(2), this.scopeStack = [], this.enterScope(1), this.regexpState = null, this.privateNameStack = [];
        }, N = {
            inFunction: {
                configurable: !0
            },
        ...
        L.strictDirective = function(e) {
            ...
            for(;;){
                ...
                var t = D.exec(this.input.slice(e));
                if (!t) return !1;
                if ("use strict" === (t[1] || t[2])) {
                    E.lastIndex = e + t[0].length;
                    var i = E.exec(this.input), s = i.index + i[0].length, r = this.input.charAt(s);
                    return ";" === r || "}" === r || v.test(i[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(r) || "!" === r && "=" === this.input.charAt(s + 1));
                }
                E.lastIndex = e += t[0].length, e += E.exec(this.input)[0].length, ";" === this.input[e] && e++;
            }
        }, L.eat = function(e) {
        ...
        O.isLet = function(e) {
            ...
            var t = E.exec(this.input), i = this.pos + t[0].length, s = this.input.charCodeAt(i);
            ...
            E.lastIndex = this.pos;
            var e, t = E.exec(this.input), i = this.pos + t[0].length;
            return !v.test(this.input.slice(this.pos, i)) && "function" === this.input.slice(i, i + 8) && (i + 8 === this.input.length || !(isIdentifierChar(e = this.input.charCodeAt(i + 8)) || e > 55295 && e < 56320));
        }, O.isUsingKeyword = function(e, t) {
            if (this.options.ecmaVersion < 17 || !this.isContextual(e ? "await" : "using")) return !1;
            E.lastIndex = this.pos;
            var i = E.exec(this.input), s = this.pos + i[0].length;
            ...
            if (e) {
                ...
                if (a && v.test(this.input.slice(n, n + a[0].length))) return !1;
            }
            if (t) {
                var o, h = s + 2;
        ...
        }, O.isAwaitUsing = function(e) {
            return this.isUsingKeyword(!0, e);
        }, O.isUsing = function(e) {
            return this.isUsingKeyword(!1, e);
        }, O.parseStatement = function(e, t, i) {
            var s, r = this.type, n = this.startNode();
            switch(this.isLet(e) && (r = x._var, s = "let"), r){
                case x._break:
                case x._continue:
                ...
                case x._import:
                    if (this.options.ecmaVersion > 10 && r === x._import) {
                        E.lastIndex = this.pos;
                        var a = E.exec(this.input), o = this.pos + a[0].length, h = this.input.charCodeAt(o);
                        if (40 === h || 46 === h) return this.parseExpressionStatement(n, this.parseExpression());
                    }
                    return !this.options.allowImportExportEverywhere && (t || this.raise(this.start, "'import' and 'export' may only appear at the top level"), this.inModule || this.raise(this.start, "'import' and 'export' may appear only with 'sourceType: module'")), r === x._import ? this.parseImport(n) : this.parseExport(n, i);
                default:
                    ...
                    if (r === x.name && "Identifier" === l.type && this.eat(x.colon)) return this.parseLabeledStatement(n, p, l, e);
                    return this.parseExpressionStatement(n, l);
            }
        }, O.parseBreakContinueStatement = function(e, t) {
            var i = "break" === t;
        ...
        }, O.parseDebuggerStatement = function(e) {
            return this.next(), this.semicolon(), this.finishNode(e, "DebuggerStatement");
        }, O.parseDoStatement = function(e) {
            return this.next(), this.labels.push(V), e.body = this.parseStatement("do"), this.labels.pop(), this.expect(x._while), e.test = this.parseParenExpression(), this.options.ecmaVersion >= 6 ? this.eat(x.semi) : this.semicolon(), this.finishNode(e, "DoWhileStatement");
        }, O.parseForStatement = function(e) {
            this.next();
            var t = this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await") ? this.lastTokStart : -1;
            if (this.labels.push(V), this.enterScope(0), this.expect(x.parenL), this.type === x.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
            var i = this.isLet();
            ...
            return this.type === x._in || (a = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (t > -1 ? (this.type === x._in && this.unexpected(t), e.await = !0) : a && this.options.ecmaVersion >= 8 && (u.start !== l || c || "Identifier" !== u.type || "async" !== u.name ? this.options.ecmaVersion >= 9 && (e.await = !1) : this.unexpected()), n && a && this.raise(u.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(u, !1, p), this.checkLValPattern(u), this.parseForIn(e, u)) : (this.checkExpressionErrors(p, !0), t > -1 && this.unexpected(t), this.parseFor(e, u));
        }, O.parseForAfterInit = function(e, t, i) {
            return (this.type === x._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && 1 === t.declarations.length ? (this.options.ecmaVersion >= 9 && (this.type === x._in ? i > -1 && this.unexpected(i) : e.await = i > -1), this.parseForIn(e, t)) : (i > -1 && this.unexpected(i), this.parseFor(e, t));
        }, O.parseFunctionStatement = function(e, t, i) {
            return this.next(), this.parseFunction(e, j | (i ? 0 : B), !1, t);
        }, O.parseIfStatement = function(e) {
        ...
        }, O.parseReturnStatement = function(e) {
        ...
        }, O.parseSwitchStatement = function(e) {
            this.next(), e.discriminant = this.parseParenExpression(), e.cases = [], this.expect(x.braceL), this.labels.push(U), this.enterScope(0);
            for(var t, i = !1; this.type !== x.braceR;)if (this.type === x._case || this.type === x._default) {
                var s = this.type === x._case;
                t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), s ? t.test = this.parseExpression() : (i && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), i = !0, t.test = null), this.expect(x.colon);
            } else t || this.unexpected(), t.consequent.push(this.parseStatement(null));
            return this.exitScope(), t && this.finishNode(t, "SwitchCase"), this.next(), this.labels.pop(), this.finishNode(e, "SwitchStatement");
        }, O.parseThrowStatement = function(e) {
        ...
        O.parseCatchClauseParam = function() {
            ...
            return this.enterScope(32 * !!t), this.checkLValPattern(e, t ? 4 : 2), this.expect(x.parenR), e;
        }, O.parseTryStatement = function(e) {
        ...
        }, O.parseVarStatement = function(e, t, i) {
            return this.next(), this.parseVar(e, !1, t, i), this.semicolon(), this.finishNode(e, "VariableDeclaration");
        }, O.parseWhileStatement = function(e) {
            return this.next(), e.test = this.parseParenExpression(), this.labels.push(V), e.body = this.parseStatement("while"), this.labels.pop(), this.finishNode(e, "WhileStatement");
        }, O.parseWithStatement = function(e) {
            return this.strict && this.raise(this.start, "'with' in strict mode"), this.next(), e.object = this.parseParenExpression(), e.body = this.parseStatement("with"), this.finishNode(e, "WithStatement");
        }, O.parseEmptyStatement = function(e) {
            return this.next(), this.finishNode(e, "EmptyStatement");
        }, O.parseLabeledStatement = function(e, t, i, s) {
            ...
            for(var a = this.type.isLoop ? "loop" : this.type === x._switch ? "switch" : null, o = this.labels.length - 1; o >= 0; o--){
                var h = this.labels[o];
                if (h.statementStart === e.start) h.statementStart = this.start, h.kind = a;
                else break;
            }
        ...
        }, O.parseExpressionStatement = function(e, t) {
            return e.expression = t, this.semicolon(), this.finishNode(e, "ExpressionStatement");
        }, O.parseBlock = function(e, t, i) {
            for(void 0 === e && (e = !0), void 0 === t && (t = this.startNode()), t.body = [], this.expect(x.braceL), e && this.enterScope(0); this.type !== x.braceR;){
                var s = this.parseStatement(null);
                t.body.push(s);
            }
            return i && (this.strict = !1), this.next(), e && this.exitScope(), this.finishNode(t, "BlockStatement");
        }, O.parseFor = function(e, t) {
        ...
        O.parseFunction = function(e, t, i, s, r) {
        ...
        }, O.parseClassElement = function(e) {
            if (this.eat(x.semi)) return null;
            var t = this.options.ecmaVersion, i = this.startNode(), s = "", r = !1, n = !1, a = "method", o = !1;
            if (this.eatContextual("static")) {
                if (t >= 13 && this.eat(x.braceL)) return this.parseClassStaticBlock(i), i;
                this.isClassElementNameStart() || this.type === x.star ? o = !0 : s = "static";
            }
            if (i.static = o, !s && t >= 8 && this.eatContextual("async") && ((this.isClassElementNameStart() || this.type === x.star) && !this.canInsertSemicolon() ? n = !0 : s = "async"), !s && (t >= 9 || !n) && this.eat(x.star) && (r = !0), !s && !n && !r) {
                var h = this.value;
                (this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? a = h : s = h);
            }
            if (s ? (i.computed = !1, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = s, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === x.parenL || "method" !== a || r || n) {
                var c = !i.static && checkKeyName(i, "constructor");
                c && "method" !== a && this.raise(i.key.start, "Constructor can't have get/set modifier"), i.kind = c ? "constructor" : a, this.parseClassMethod(i, r, n, c && e);
        ...
        }, O.parseClassElementName = function(e) {
            this.type === x.privateId ? ("constructor" === this.value && this.raise(this.start, "Classes can't have an element named '#constructor'"), e.computed = !1, e.key = this.parsePrivateIdent()) : this.parsePropertyName(e);
        }, O.parseClassMethod = function(e, t, i, s) {
            var r = e.key;
        ...
        }, O.parseClassField = function(e) {
            return checkKeyName(e, "constructor") ? this.raise(e.key.start, "Classes can't have a field named 'constructor'") : e.static && checkKeyName(e, "prototype") && this.raise(e.key.start, "Classes can't have a static field named 'prototype'"), this.eat(x.eq) ? (this.enterScope(576), e.value = this.parseMaybeAssign(), this.exitScope()) : e.value = null, this.semicolon(), this.finishNode(e, "PropertyDefinition");
        }, O.parseClassStaticBlock = function(e) {
            e.body = [];
            var t = this.labels;
        ...
        }, O.parseClassId = function(e, t) {
            this.type === x.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, 2, !1)) : (!0 === t && this.unexpected(), e.id = null);
        }, O.parseClassSuper = function(e) {
            ...
            if (this.options.checkPrivateFields) for(var s = this.privateNameStack.length, r = 0 === s ? null : this.privateNameStack[s - 1], n = 0; n < i.length; ++n){
                var a = i[n];
                w(t, a.name) || (r ? r.used.push(a) : this.raiseRecoverable(a.start, "Private field '#" + a.name + "' must be declared in an enclosing class"));
            }
        }, O.parseExportAllDeclaration = function(e, t) {
        ...
        }, O.checkExport = function(e, t, i) {
            e && ("string" != typeof t && (t = "Identifier" === t.type ? t.name : t.value), w(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"), e[t] = !0);
        }, O.checkPatternExport = function(e, t) {
            var i = t.type;
        ...
        }, O.checkVariableExport = function(e, t) {
        ...
        }, O.parseExportSpecifier = function(e) {
            var t = this.startNode();
        ...
        }, O.parseExportSpecifiers = function(e) {
            var t = [], i = !0;
            ...
            return t;
        }, O.parseImport = function(e) {
            return this.next(), this.type === x.string ? (e.specifiers = M, e.source = this.parseExprAtom()) : (e.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), e.source = this.type === x.string ? this.parseExprAtom() : this.unexpected()), this.options.ecmaVersion >= 16 && (e.attributes = this.parseWithClause()), this.semicolon(), this.finishNode(e, "ImportDeclaration");
            ...
            for(var t = {}, i = !0; !this.eat(x.braceR);){
                if (i) i = !1;
                else if (this.expect(x.comma), this.afterTrailingComma(x.braceR)) break;
            ...
            var e = this.startNode();
            return e.key = this.type === x.string ? this.parseExprAtom() : this.parseIdent("never" !== this.options.allowReserved), this.expect(x.colon), this.type !== x.string && this.unexpected(), e.value = this.parseExprAtom(), this.finishNode(e, "ImportAttribute");
        }, O.parseModuleExportName = function() {
            if (this.options.ecmaVersion >= 13 && this.type === x.string) {
                var e = this.parseLiteral(this.value);
                return R.test(e.value) && this.raise(e.start, "An export name cannot include a lone surrogate."), e;
            }
            return this.parseIdent(!0);
        }, O.adaptDirectivePrologue = function(e) {
            for(var t = 0; t < e.length && this.isDirectiveCandidate(e[t]); ++t)e[t].directive = e[t].expression.raw.slice(1, -1);
        }, O.isDirectiveCandidate = function(e) {
        ...
        F.toAssignable = function(e, t, i) {
            ...
            for(var r = [], n = !0; !this.eat(e);)if (n ? n = !1 : this.expect(x.comma), t && this.type === x.comma) r.push(null);
            else if (i && this.afterTrailingComma(e)) break;
            else if (this.type === x.ellipsis) {
                var a = this.parseRestBinding();
                this.parseBindingListItem(a), r.push(a), this.type === x.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.expect(e);
                break;
            ...
            switch(e.type){
                case "Identifier":
                    this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (s ? "Binding " : "Assigning to ") + e.name + " in strict mode"), s && (2 === t && "let" === e.name && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), i && (w(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), i[e.name] = !0), 5 !== t && this.declareName(e.name, t, e.start));
                    break;
                case "ChainExpression":
                    this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
                    break;
        ...
        q.initialContext = function() {
            ...
            return t === $.f_expr || t === $.f_stat || (e === x.colon && (t === $.b_stat || t === $.b_expr) ? !t.isExpr : e === x._return || e === x.name && this.exprAllowed ? v.test(this.input.slice(this.lastTokEnd, this.start)) : e === x._else || e === x.semi || e === x.eof || e === x.parenR || e === x.arrow || (e === x.braceL ? t === $.b_stat : e !== x._var && e !== x._const && e !== x.name && !this.exprAllowed));
            ...
            var t, i = this.type;
            i.keyword && e === x.dot ? this.exprAllowed = !1 : (t = i.updateContext) ? t.call(this, e) : this.exprAllowed = i.beforeExpr;
            ...
            e === $.b_stat && "function" === this.curContext().token && (e = this.context.pop()), this.exprAllowed = !e.isExpr;
            ...
            e.beforeExpr && e !== x._else && (e !== x.semi || this.curContext() === $.p_stat) && !(e === x._return && v.test(this.input.slice(this.lastTokEnd, this.start))) && (e !== x.colon && e !== x.braceL || this.curContext() !== $.b_stat) ? this.context.push($.f_expr) : this.context.push($.f_stat), this.exprAllowed = !1;
        ...
        W.checkPropClash = function(e, t, i) {
            if ((!(this.options.ecmaVersion >= 9) || "SpreadElement" !== e.type) && (!(this.options.ecmaVersion >= 6) || !e.computed && !e.method && !e.shorthand)) {
                ...
                if (this.options.ecmaVersion >= 6) {
                    "__proto__" === s && "init" === n && (t.proto && (i ? i.doubleProto < 0 && (i.doubleProto = r.start) : this.raiseRecoverable(r.start, "Redefinition of __proto__ property")), t.proto = !0);
                    return;
                }
                var a = t[s = "$" + s];
                a ? ("init" === n ? this.strict && a.init || a.get || a.set : a.init || a[n]) && this.raiseRecoverable(r.start, "Redefinition of property") : a = t[s] = {
                    init: !1,
                    get: !1,
                    set: !1
                }, a[n] = !0;
            ...
            if (this.type === x.comma) {
                ...
                for(n.expressions = [
                    r
                ]; this.eat(x.comma);)n.expressions.push(this.parseMaybeAssign(e, t));
                return this.finishNode(n, "SequenceExpression");
            }
            return r;
        }, W.parseMaybeAssign = function(e, t, i) {
            if (this.isContextual("yield")) if (this.inGenerator) return this.parseYield(e);
            ...
            (this.type === x.parenL || this.type === x.name) && (this.potentialArrowAt = this.start, this.potentialArrowInForAwait = "await" === e);
            var c = this.parseMaybeConditional(e, t);
            if (i && (c = i.call(this, c, o, h)), this.type.isAssign) {
                var p = this.startNodeAt(o, h);
                return p.operator = this.value, this.type === x.eq && (c = this.toAssignable(c, !1, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= c.start && (t.shorthandAssign = -1), this.type === x.eq ? this.checkLValPattern(c) : this.checkLValSimple(c), p.left = c, this.next(), p.right = this.parseMaybeAssign(e), a > -1 && (t.doubleProto = a), this.finishNode(p, "AssignmentExpression");
            }
            ...
            if (this.eat(x.question)) {
                var n = this.startNodeAt(i, s);
                return n.test = r, n.consequent = this.parseMaybeAssign(), this.expect(x.colon), n.alternate = this.parseMaybeAssign(e), this.finishNode(n, "ConditionalExpression");
            }
            return r;
            ...
            if (null != n && (!r || this.type !== x._in) && n > s) {
                var a = this.type === x.logicalOR || this.type === x.logicalAND, o = this.type === x.coalesce;
                o && (n = x.logicalAND.binop);
                var h = this.value;
                this.next();
                ...
                return (a && this.type === x.coalesce || o && (this.type === x.logicalOR || this.type === x.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(u, t, i, s, r);
            }
            return e;
        }, W.buildBinary = function(e, t, i, s, r, n) {
            ...
            if (this.isContextual("await") && this.canAwait) r = this.parseAwait(s), t = !0;
                ...
                var o = this.startNode(), h = this.type === x.incDec;
            ...
            } else if (t || this.type !== x.privateId) {
            ...
            } else (s || 0 === this.privateNameStack.length) && this.options.checkPrivateFields && this.unexpected(), r = this.parsePrivateIdent(), this.type !== x._in && this.unexpected();
            return !i && this.eat(x.starstar) ? t ? void this.unexpected(this.lastTokStart) : this.buildBinary(n, a, r, this.parseMaybeUnary(null, !1, !1, s), "**", !1) : r;
        ...
        }, W.parseSubscript = function(e, t, i, s, r, n, a) {
            var o = this.options.ecmaVersion >= 11, h = o && this.eat(x.questionDot);
            s && h && this.raise(this.lastTokStart, "Optional chaining cannot appear in the callee of new expressions");
            var c = this.eat(x.bracketL);
            if (c || h && this.type !== x.parenL && this.type !== x.backQuote || this.eat(x.dot)) {
                var p = this.startNodeAt(t, i);
                p.object = e, c ? (p.property = this.parseExpression(), this.expect(x.bracketR)) : this.type === x.privateId && "Super" !== e.type ? p.property = this.parsePrivateIdent() : p.property = this.parseIdent("never" !== this.options.allowReserved), p.computed = !!c, o && (p.optional = h), e = this.finishNode(p, "MemberExpression");
            } else if (!s && this.eat(x.parenL)) {
                var l = new acorn_DestructuringErrors, u = this.yieldPos, d = this.awaitPos, f = this.awaitIdentPos;
                this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0;
                var m = this.parseExprList(x.parenR, this.options.ecmaVersion >= 8, !1, l);
                ...
                _.tag = e, _.quasi = this.parseTemplate({
                    isTagged: !0
            ...
            switch(this.type){
                ...
                case x.name:
                    ...
                    if (this.options.ecmaVersion >= 8 && !o && "async" === h.name && !this.canInsertSemicolon() && this.eat(x._function)) return this.overrideContext($.f_expr), this.parseFunction(this.startNodeAt(n, a), 0, !1, !0, t);
                    if (r && !this.canInsertSemicolon()) {
                        if (this.eat(x.arrow)) return this.parseArrowExpression(this.startNodeAt(n, a), [
                            h
                        ], !1, t);
                        if (this.options.ecmaVersion >= 8 && "async" === h.name && this.type === x.name && !o && (!this.potentialArrowInForAwait || "of" !== this.value || this.containsEsc)) return h = this.parseIdent(!1), (this.canInsertSemicolon() || !this.eat(x.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, a), [
                            h
                        ], !0, t);
                    }
                    return h;
                ...
                case x._true:
                case x._false:
                    return (s = this.startNode()).value = this.type === x._null ? null : this.type === x._true, s.raw = this.type.keyword, this.next(), this.finishNode(s, "Literal");
                case x.parenL:
                ...
                case x.bracketL:
                    return s = this.startNode(), this.next(), s.elements = this.parseExprList(x.bracketR, !0, !0, e), this.finishNode(s, "ArrayExpression");
                case x.braceL:
            ...
            var t = this.startNode();
            if (this.containsEsc && this.raiseRecoverable(this.start, "Escape sequence in keyword import"), this.next(), this.type === x.parenL && !e) return this.parseDynamicImport(t);
            if (this.type === x.dot) {
            ...
            if (this.next(), e.source = this.parseMaybeAssign(), this.options.ecmaVersion >= 16) this.eat(x.parenR) ? e.options = null : (this.expect(x.comma), this.afterTrailingComma(x.parenR) ? e.options = null : (e.options = this.parseMaybeAssign(), !this.eat(x.parenR) && (this.expect(x.comma), this.afterTrailingComma(x.parenR) || this.unexpected())));
            else if (!this.eat(x.parenR)) {
                var t = this.start;
                this.eat(x.comma) && this.eat(x.parenR) ? this.raiseRecoverable(t, "Trailing comma is not allowed in import()") : this.unexpected(t);
            }
            ...
            if (this.options.ecmaVersion >= 6) {
                this.next();
                var a, o = this.start, h = this.startLoc, c = [], p = !0, l = !1, u = new acorn_DestructuringErrors, d = this.yieldPos, f = this.awaitPos;
                for(this.yieldPos = 0, this.awaitPos = 0; this.type !== x.parenR;){
                    if (p ? p = !1 : this.expect(x.comma), n && this.afterTrailingComma(x.parenR, !0)) {
                        l = !0;
                        break;
                    }
                    if (this.type === x.ellipsis) {
                        a = this.start, c.push(this.parseParenItem(this.parseRestBinding())), this.type === x.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
                        break;
                    }
                    c.push(this.parseMaybeAssign(!1, u, this.parseParenItem));
                }
                var m = this.lastTokEnd, g = this.lastTokEndLoc;
                if (this.expect(x.parenR), e && this.shouldParseArrow(c) && this.eat(x.arrow)) return this.checkPatternErrors(u, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = d, this.awaitPos = f, this.parseParenArrowList(s, r, c, t);
                (!c.length || l) && this.unexpected(this.lastTokStart), a && this.unexpected(a), this.checkExpressionErrors(u, !0), this.yieldPos = d || this.yieldPos, this.awaitPos = f || this.awaitPos, c.length > 1 ? ((i = this.startNodeAt(o, h)).expressions = c, this.finishNodeAt(i, "SequenceExpression", m, g)) : i = c[0];
            } else i = this.parseParenExpression();
            if (!this.options.preserveParens) return i;
            var _ = this.startNodeAt(s, r);
        ...
        W.parseNew = function() {
            ...
            return e.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), s, r, !0, !1), this.eat(x.parenL) ? e.arguments = this.parseExprList(x.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = G, this.finishNode(e, "NewExpression");
        }, W.parseTemplateElement = function(e) {
            var t = e.isTagged, i = this.startNode();
            return this.type === x.invalidTemplate ? (t || this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal"), i.value = {
            ...
            for(i.quasis = [
                s
            ]; !s.tail;)this.type === x.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(x.dollarBraceL), i.expressions.push(this.parseExpression()), this.expect(x.braceR), i.quasis.push(s = this.parseTemplateElement({
                isTagged: t
            }));
            return this.next(), this.finishNode(i, "TemplateLiteral");
        }, W.isAsyncProp = function(e) {
            return !e.computed && "Identifier" === e.key.type && "async" === e.key.name && (this.type === x.name || this.type === x.num || this.type === x.string || this.type === x.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === x.star) && !v.test(this.input.slice(this.lastTokEnd, this.start));
            ...
            if (this.options.ecmaVersion >= 9 && this.eat(x.ellipsis)) return e ? (a.argument = this.parseIdent(!1), this.type === x.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.finishNode(a, "RestElement")) : (a.argument = this.parseMaybeAssign(!1, t), this.type === x.comma && t && t.trailingComma < 0 && (t.trailingComma = this.start), this.finishNode(a, "SpreadElement"));
            this.options.ecmaVersion >= 6 && (a.method = !1, a.shorthand = !1, (e || t) && (r = this.start, n = this.startLoc), e || (i = this.eat(x.star)));
            var o = this.containsEsc;
            return this.parsePropertyName(a), !e && !o && this.options.ecmaVersion >= 8 && !i && this.isAsyncProp(a) ? (s = !0, i = this.options.ecmaVersion >= 9 && this.eat(x.star), this.parsePropertyName(a)) : s = !1, this.parsePropertyValue(a, e, i, s, r, n, t, o), this.finishNode(a, "Property");
        ...
        }, W.parsePropertyValue = function(e, t, i, s, r, n, a, o) {
            ...
            if (this.options.ecmaVersion >= 6) if (this.eat(x.bracketL)) return e.computed = !0, e.key = this.parseMaybeAssign(), this.expect(x.bracketR), e.key;
            else e.computed = !1;
            ...
            var r = t && this.type !== x.braceL, n = this.strict, a = !1;
            ...
            for(var t = 0; t < e.length; t += 1)if ("Identifier" !== e[t].type) return !1;
            return !0;
            ...
            var e = this.startNode();
            return this.type === x.name ? e.name = this.value : this.type.keyword ? (e.name = this.type.keyword, ("class" === e.name || "function" === e.name) && (this.lastTokEnd !== this.lastTokStart + 1 || 46 !== this.input.charCodeAt(this.lastTokStart)) && this.context.pop(), this.type = x.name) : this.unexpected(), e;
        }, W.parsePrivateIdent = function() {
            var e = this.startNode();
            return this.type === x.privateId ? e.name = this.value : this.unexpected(), this.next(), this.finishNode(e, "PrivateIdentifier"), this.options.checkPrivateFields && (0 === this.privateNameStack.length ? this.raise(e.start, "Private field '#" + e.name + "' must be declared in an enclosing class") : this.privateNameStack[this.privateNameStack.length - 1].used.push(e)), e;
        ...
        var z = acorn_Parser.prototype, acorn_Scope = function(e) {
        ...
        }, K.finishNodeAt = function(e, t, i, s) {
        ...
        var Z = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS", J = Z + " Extended_Pictographic", Y = J + " EBase EComp EMod EPres ExtPict", Q = {
            ...
            12: er,
            13: en,
            14: en + " Gara Garay Gukh Gurung_Khema Hrkt Katakana_Or_Hiragana Kawi Kirat_Rai Krai Nag_Mundari Nagm Ol_Onal Onao Sunu Sunuwar Todhri Todr Tulu_Tigalari Tutg Unknown Zzzz"
        }, eo = {};
        function buildUnicodeData(e) {
            var t = eo[e] = {
                binary: wordsRegexp(Q[e] + " " + ee),
                binaryOfStrings: wordsRegexp(X[e]),
                nonBinary: {
                    General_Category: wordsRegexp(ee),
                    Script: wordsRegexp(ea[e])
                }
            };
        ...
        for(var eh = 0, ec = [
            ...
            13,
            14
        ]; eh < ec.length; eh += 1)buildUnicodeData(ec[eh]);
        var ep = acorn_Parser.prototype, acorn_BranchID = function(e, t) {
        ...
        acorn_RegExpValidationState.prototype.reset = function(e, t, i) {
            ...
            return n >= 56320 && n <= 57343 ? (r << 10) + n - 0x35fdc00 : r;
            ...
            void 0 === t && (t = !1);
            for(var i = this.pos, s = 0; s < e.length; s += 1){
                var r = e[s], n = this.at(i, t);
                if (-1 === n || n !== r) return !1;
                i = this.nextIndex(i, t);
            }
            return this.pos = i, !0;
        }, ep.validateRegExpFlags = function(e) {
        ...
        }, ep.regexp_disjunction = function(e) {
        ...
        }, ep.regexp_alternative = function(e) {
            for(; e.pos < e.source.length && this.regexp_eatTerm(e););
        }, ep.regexp_eatTerm = function(e) {
        ...
        }, ep.regexp_eatAssertion = function(e) {
            var t = e.pos;
            ...
            return e.pos = t, !1;
        }, ep.regexp_eatQuantifier = function(e, t) {
            return void 0 === t && (t = !1), !!this.regexp_eatQuantifierPrefix(e, t) && (e.eat(63), !0);
        }, ep.regexp_eatQuantifierPrefix = function(e, t) {
            return e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, t);
        }, ep.regexp_eatBracedQuantifier = function(e, t) {
            var i = e.pos;
            if (e.eat(123)) {
                var s = 0, r = -1;
            ...
            return !1;
        }, ep.regexp_eatAtom = function(e) {
            return this.regexp_eatPatternCharacters(e) || e.eat(46) || this.regexp_eatReverseSolidusAtomEscape(e) || this.regexp_eatCharacterClass(e) || this.regexp_eatUncapturingGroup(e) || this.regexp_eatCapturingGroup(e);
        }, ep.regexp_eatReverseSolidusAtomEscape = function(e) {
            var t = e.pos;
            if (e.eat(92)) {
            ...
            return !1;
        }, ep.regexp_eatUncapturingGroup = function(e) {
            var t = e.pos;
            if (e.eat(40)) {
                if (e.eat(63)) {
            ...
            return !1;
        }, ep.regexp_eatCapturingGroup = function(e) {
            if (e.eat(40)) {
        ...
        }, ep.regexp_eatGroupName = function(e) {
            if (e.lastStringValue = "", e.eat(60)) {
                if (this.regexp_eatRegExpIdentifierName(e) && e.eat(62)) return !0;
                e.raise("Invalid capture group name");
            }
            return !1;
        }, ep.regexp_eatRegExpIdentifierName = function(e) {
            ...
            return !1;
        }, ep.regexp_eatRegExpIdentifierStart = function(e) {
            var t = e.pos, i = this.options.ecmaVersion >= 11, s = e.current(i);
            return (e.advance(i), 92 === s && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue), isRegExpIdentifierStart(s)) ? (e.lastIntValue = s, !0) : (e.pos = t, !1);
        }, ep.regexp_eatRegExpIdentifierPart = function(e) {
            var t = e.pos, i = this.options.ecmaVersion >= 11, s = e.current(i);
            return (e.advance(i), 92 === s && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue), isRegExpIdentifierPart(s)) ? (e.lastIntValue = s, !0) : (e.pos = t, !1);
        }, ep.regexp_eatAtomEscape = function(e) {
        ...
        }, ep.regexp_eatBackReference = function(e) {
            var t = e.pos;
        ...
        }, ep.regexp_eatControlLetter = function(e) {
            var t = e.current();
            return !!isControlLetter(t) && (e.lastIntValue = t % 32, e.advance(), !0);
        }, ep.regexp_eatRegExpUnicodeEscapeSequence = function(e, t) {
            void 0 === t && (t = !1);
                ...
                if (this.regexp_eatFixedHexDigits(e, 4)) {
                    ...
                    if (s && r >= 55296 && r <= 56319) {
                        ...
                        if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
                            ...
                            if (a >= 56320 && a <= 57343) return e.lastIntValue = (r - 55296) * 1024 + (a - 56320) + 65536, !0;
                        }
                        e.pos = n, e.lastIntValue = r;
                    }
                    return !0;
                }
                if (s && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && isValidUnicode(e.lastIntValue)) return !0;
                s && e.raise("Invalid unicode escape"), e.pos = i;
            }
            return !1;
        }, ep.regexp_eatIdentityEscape = function(e) {
        ...
        }, ep.regexp_eatDecimalEscape = function(e) {
            e.lastIntValue = 0;
            var t = e.current();
            if (t >= 49 && t <= 57) {
            ...
            return !1;
        }, ep.regexp_eatCharacterClassEscape = function(e) {
            var t, i = e.current();
            if (isCharacterClassEscape(i)) return e.lastIntValue = -1, e.advance(), 1;
            var s = !1;
            if (e.switchU && this.options.ecmaVersion >= 9 && ((s = 80 === i) || 112 === i)) {
                if (e.lastIntValue = -1, e.advance(), e.eat(123) && (t = this.regexp_eatUnicodePropertyValueExpression(e)) && e.eat(125)) return s && 2 === t && e.raise("Invalid property name"), t;
                e.raise("Invalid property name");
            }
            return 0;
        }, ep.regexp_eatUnicodePropertyValueExpression = function(e) {
            var t = e.pos;
            ...
            return 0;
        }, ep.regexp_validateUnicodePropertyNameAndValue = function(e, t, i) {
        ...
        }, ep.regexp_validateUnicodePropertyNameOrValue = function(e, t) {
        ...
        }, ep.regexp_eatClassAtom = function(e) {
            var t = e.pos;
            if (e.eat(92)) {
        ...
        }, ep.regexp_eatClassEscape = function(e) {
            var t = e.pos;
        ...
        }, ep.regexp_classSetExpression = function(e) {
            var t, i = 1;
            if (this.regexp_eatClassSetRange(e)) ;
                ...
                for(var s = e.pos; e.eatChars([
                    ...
                    if (38 !== e.current() && (t = this.regexp_eatClassSetOperand(e))) {
                        2 !== t && (i = 1);
                        continue;
                    }
        ...
        }, ep.regexp_eatClassSetRange = function(e) {
            var t = e.pos;
            ...
            return null;
        }, ep.regexp_eatClassStringDisjunction = function(e) {
            var t = e.pos;
            if (e.eatChars([
                92,
                113
            ...
            return null;
        }, ep.regexp_classStringDisjunctionContents = function(e) {
            for(var t = this.regexp_classString(e); e.eat(124);)2 === this.regexp_classString(e) && (t = 2);
            return t;
        }, ep.regexp_classString = function(e) {
            for(var t = 0; this.regexp_eatClassSetCharacter(e);)t++;
            return 1 === t ? 1 : 2;
        }, ep.regexp_eatClassSetCharacter = function(e) {
            var t = e.pos;
            ...
            var i = e.current();
            return !(i < 0 || i === e.lookahead() && isClassSetReservedDoublePunctuatorCharacter(i) || isClassSetSyntaxCharacter(i)) && (e.advance(), e.lastIntValue = i, !0);
        }, ep.regexp_eatClassSetReservedPunctuator = function(e) {
            var t = e.current();
            return !!isClassSetReservedPunctuator(t) && (e.lastIntValue = t, e.advance(), !0);
        }, ep.regexp_eatClassControlLetter = function(e) {
            var t = e.current();
            return (!!isDecimalDigit(t) || 95 === t) && (e.lastIntValue = t % 32, e.advance(), !0);
        }, ep.regexp_eatHexEscapeSequence = function(e) {
            var t = e.pos;
            if (e.eat(120)) {
            ...
            return !1;
        }, ep.regexp_eatOctalDigit = function(e) {
            var t = e.current();
            return isOctalDigit(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1);
        }, ep.regexp_eatFixedHexDigits = function(e, t) {
            var i = e.pos;
            e.lastIntValue = 0;
            for(var s = 0; s < t; ++s){
                var r = e.current();
        ...
        el.next = function(e) {
            ...
            e: for(; this.pos < this.input.length;){
                ...
                switch(e){
                    ...
                    case 47:
                        ...
                        break;
                    default:
                        if (e > 8 && e < 14 || e >= 5760 && b.test(String.fromCharCode(e))) ++this.pos;
                        else break e;
                }
            }
        }, el.finishToken = function(e, t) {
        ...
        }, el.readToken_mult_modulo_exp = function(e) {
            var t = this.input.charCodeAt(this.pos + 1), i = 1, s = 42 === e ? x.star : x.modulo;
            return (this.options.ecmaVersion >= 7 && 42 === e && 42 === t && (++i, s = x.starstar, t = this.input.charCodeAt(this.pos + 2)), 61 === t) ? this.finishOp(x.assign, i + 1) : this.finishOp(s, i);
        }, el.readToken_pipe_amp = function(e) {
            var t = this.input.charCodeAt(this.pos + 1);
            if (t === e) return this.options.ecmaVersion >= 12 && 61 === this.input.charCodeAt(this.pos + 2) ? this.finishOp(x.assign, 3) : this.finishOp(124 === e ? x.logicalOR : x.logicalAND, 2);
            return 61 === t ? this.finishOp(x.assign, 2) : this.finishOp(124 === e ? x.bitwiseOR : x.bitwiseAND, 1);
        ...
        }, el.readToken_plus_min = function(e) {
            var t = this.input.charCodeAt(this.pos + 1);
            return t === e ? 45 === t && !this.inModule && 62 === this.input.charCodeAt(this.pos + 2) && (0 === this.lastTokEnd || v.test(this.input.slice(this.lastTokEnd, this.pos))) ? (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : this.finishOp(x.incDec, 2) : 61 === t ? this.finishOp(x.assign, 2) : this.finishOp(x.plusMin, 1);
        }, el.readToken_lt_gt = function(e) {
            var t = this.input.charCodeAt(this.pos + 1), i = 1;
            return t === e ? (i = 62 === e && 62 === this.input.charCodeAt(this.pos + 2) ? 3 : 2, 61 === this.input.charCodeAt(this.pos + i)) ? this.finishOp(x.assign, i + 1) : this.finishOp(x.bitShift, i) : 33 !== t || 60 !== e || this.inModule || 45 !== this.input.charCodeAt(this.pos + 2) || 45 !== this.input.charCodeAt(this.pos + 3) ? (61 === t && (i = 2), this.finishOp(x.relational, i)) : (this.skipLineComment(4), this.skipSpace(), this.nextToken());
        }, el.readToken_eq_excl = function(e) {
            var t = this.input.charCodeAt(this.pos + 1);
            ...
            if (e >= 11) {
                ...
                if (63 === t) return e >= 12 && 61 === this.input.charCodeAt(this.pos + 2) ? this.finishOp(x.assign, 3) : this.finishOp(x.coalesce, 2);
            }
            return this.finishOp(x.question, 1);
        }, el.readToken_numberSign = function() {
            var e = this.options.ecmaVersion, t = 35;
            if (e >= 13 && (++this.pos, isIdentifierStart(t = this.fullCharCodeAtPos(), !0) || 92 === t)) return this.finishToken(x.privateId, this.readWord1());
            this.raise(this.pos, "Unexpected character '" + codePointToString(t) + "'");
        }, el.getTokenFromCode = function(e) {
            switch(e){
                case 46:
            ...
            for(var s = this.options.ecmaVersion >= 12 && void 0 === t, r = i && 48 === this.input.charCodeAt(this.pos), n = this.pos, a = 0, o = 0, h = 0, c = null == t ? 1 / 0 : t; h < c; ++h, ++this.pos){
                ...
                if (s && 95 === p) {
                    r && this.raiseRecoverable(this.pos, "Numeric separator is not allowed in legacy octal numeric literals"), 95 === o && this.raiseRecoverable(this.pos, "Numeric separator must be exactly one underscore"), 0 === h && this.raiseRecoverable(this.pos, "Numeric separator is not allowed at the first of digits"), o = p;
                    continue;
                }
        ...
        }, el.readRadixNumber = function(e) {
            var t = this.pos;
            this.pos += 2;
            var i = this.readInt(e);
            return null == i && this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && 110 === this.input.charCodeAt(this.pos) ? (i = stringToBigInt(this.input.slice(t, this.pos)), ++this.pos) : isIdentifierStart(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(x.num, i);
        }, el.readNumber = function(e) {
            var t = this.pos;
            ...
            if (!i && !e && this.options.ecmaVersion >= 11 && 110 === s) {
                ...
                return ++this.pos, isIdentifierStart(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(x.num, r);
            }
            ...
            var n = stringToNumber(this.input.slice(t, this.pos), i);
            ...
            return t += this.input.slice(i, this.pos++), this.finishToken(x.string, t);
        };
        var eu = {};
        el.tryReadTemplateToken = function() {
            ...
            try {
                ...
                if (e === eu) this.readInvalidTemplateToken();
                else throw e;
            }
            this.inTemplateElement = !1;
        }, el.invalidStringToken = function(e, t) {
            ...
            for(var e = "", t = this.pos;;){
                ...
                if (96 === i || 36 === i && 123 === this.input.charCodeAt(this.pos + 1)) {
                    if (this.pos === this.start && (this.type === x.template || this.type === x.invalidTemplate)) if (36 === i) return this.pos += 2, this.finishToken(x.dollarBraceL);
                    else return ++this.pos, this.finishToken(x.backQuote);
                    return e += this.input.slice(t, this.pos), this.finishToken(x.template, e);
                }
            ...
            switch(++this.pos, t){
                ...
                default:
                    if (t >= 48 && t <= 55) {
                        ...
                        return r > 255 && (r = parseInt(s = s.slice(0, -1), 8)), this.pos += s.length - 1, t = this.input.charCodeAt(this.pos), ("0" !== s || 56 === t || 57 === t) && (this.strict || e) && this.invalidStringToken(this.pos - 1 - s.length, e ? "Octal literal in template string" : "Octal literal in strict mode"), String.fromCharCode(r);
                    }
                    if (isNewLine(t)) return this.options.locations && (this.lineStart = this.pos, ++this.curLine), "";
                    return String.fromCharCode(t);
            }
        }, el.readHexChar = function(e) {
        ...
        let ed = __turbopack_context__.r("[externals]/node:module [external] (node:module, cjs)"), ef = __turbopack_context__.r("[externals]/node:fs [external] (node:fs, cjs)"), em = /\/$|\/\?|\/#/, eg = /^\.?\//;
        function hasTrailingSlash(e = "", t) {
            return t ? em.test(e) : e.endsWith("/");
        }
        function withTrailingSlash(e = "", t) {
            if (!t) return e.endsWith("/") ? e : e + "/";
            if (hasTrailingSlash(e, !0)) return e || "/";
            let i = e, s = "", r = e.indexOf("#");
        ...
        function dist_joinURL(e, ...t) {
            let i = e || "";
            for (let e of t.filter((e)=>isNonEmptyURL(e)))if (i) {
                let t = e.replace(eg, "");
        ...
        function pathe_M_eThtNZ_normalizeWindowsPath(e = "") {
            return e ? e.replace(/\\/g, "/").replace(e_, (e)=>e.toUpperCase()) : e;
        }
        let ex = /^[/\\]{2}/, ev = /^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/, ey = /^[A-Za-z]:$/, eb = /.(\.[^./]+|\.)$/, pathe_M_eThtNZ_normalize = function(e) {
            if (0 === e.length) return ".";
            let t = (e = pathe_M_eThtNZ_normalizeWindowsPath(e)).match(ex), i = isAbsolute(e), s = "/" === e[e.length - 1];
            return 0 === (e = normalizeString(e, !i)).length ? i ? "/" : s ? "./" : "." : (s && (e += "/"), ey.test(e) && (e += "/"), t) ? i ? `//${e}` : `//./${e}` : i && !isAbsolute(e) ? `/${e}` : e;
        }, pathe_M_eThtNZ_join = function(...e) {
            let t = "";
            for (let i of e)if (i) if (t.length > 0) {
                let e = "/" === t[t.length - 1], s = "/" === i[0];
                e && s ? t += i.slice(1) : t += e || s ? i : `/${i}`;
            } else t += i;
        ...
        let pathe_M_eThtNZ_resolve = function(...e) {
            e = e.map((e)=>pathe_M_eThtNZ_normalizeWindowsPath(e));
            let t = "", i = !1;
            for(let s = e.length - 1; s >= -1 && !i; s--){
                let r = s >= 0 ? e[s] : pathe_M_eThtNZ_cwd();
                ...
                if ("/" === a) {
                    if (r === o - 1 || 1 === n) ;
                        ...
                        if (i.length < 2 || 2 !== s || "." !== i[i.length - 1] || "." !== i[i.length - 2]) {
                            if (i.length > 2) {
                                let e = i.lastIndexOf("/");
                                -1 === e ? (i = "", s = 0) : s = (i = i.slice(0, e)).length - 1 - i.lastIndexOf("/"), r = o, n = 0;
                                continue;
                            } else if (i.length > 0) {
                                i = "", s = 0, r = o, n = 0;
                                continue;
        ...
        let isAbsolute = function(e) {
            return ev.test(e);
        }, extname = function(e) {
            if (".." === e) return "";
            let t = eb.exec(pathe_M_eThtNZ_normalizeWindowsPath(e));
            return t && t[1] || "";
        }, pathe_M_eThtNZ_dirname = function(e) {
            let t = pathe_M_eThtNZ_normalizeWindowsPath(e).replace(/\/$/, "").split("/").slice(0, -1);
            return 1 === t.length && ey.test(t[0]) && (t[0] += "/"), t.join("/") || (isAbsolute(e) ? "/" : ".");
        }, basename = function(e, t) {
            let i = pathe_M_eThtNZ_normalizeWindowsPath(e).split("/"), s = "";
        ...
        }, eE = __turbopack_context__.r("[externals]/node:url [external] (node:url, cjs)"), ek = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)"), eS = __turbopack_context__.r("[externals]/node:process [external] (node:process, cjs)"), eC = __turbopack_context__.r("[externals]/node:path [external] (node:path, cjs)"), ew = __turbopack_context__.r("[externals]/node:v8 [external] (node:v8, cjs)"), eT = __turbopack_context__.r("[externals]/node:util [external] (node:util, cjs)"), eI = new Set(ed.builtinModules);
        function normalizeSlash(e) {
            return e.replace(/\\/g, "/");
        }
        let eR = {}.hasOwnProperty, eP = /^([A-Z][a-z\d]*)+$/, eA = new Set([
            "string",
            "function",
            "number",
            "object",
        ...
        function createError(e, t, i) {
            return eL.set(e, t), makeNodeErrorWithCode(i, e);
        }
        ...
        function isErrorStackTraceLimitWritable() {
            try {
                if (ew.startupSnapshot.isBuildingSnapshot()) return !1;
            } catch  {}
            let e = Object.getOwnPropertyDescriptor(Error, "stackTraceLimit");
            return void 0 === e ? Object.isExtensible(Error) : eR.call(e, "writable") && void 0 !== e.writable ? e.writable : void 0 !== e.set;
        }
        eN.ERR_INVALID_ARG_TYPE = createError("ERR_INVALID_ARG_TYPE", (e, t, i)=>{
            ek("string" == typeof e, "'name' must be a string"), Array.isArray(t) || (t = [
                t
            ]);
            let s = "The ";
            ...
            s += "must be ";
            let r = [], n = [], a = [];
            for (let e of t)ek("string" == typeof e, "All expected entries have to be of type string"), eA.has(e) ? r.push(e.toLowerCase()) : null === eP.exec(e) ? (ek("object" !== e, 'The value "object" should be written as "Object"'), a.push(e)) : n.push(e);
            if (n.length > 0) {
                let e = r.indexOf("object");
                -1 !== e && (r.slice(e, 1), n.push("Object"));
            }
            return r.length > 0 && (s += `${r.length > 1 ? "one of type" : "of type"} ${formatList(r, "or")}`, (n.length > 0 || a.length > 0) && (s += " or ")), n.length > 0 && (s += `an instance of ${formatList(n, "or")}`, a.length > 0 && (s += " or ")), a.length > 0 && (a.length > 1 ? s += `one of ${formatList(a, "or")}` : (a[0].toLowerCase() !== a[0] && (s += "an "), s += `${a[0]}`)), s += `. Received ${determineSpecificType(i)}`;
        }, TypeError), eN.ERR_INVALID_MODULE_SPECIFIER = createError("ERR_INVALID_MODULE_SPECIFIER", (e, t, i)=>`Invalid module "${e}" ${t}${i ? ` imported from ${i}` : ""}`, TypeError), eN.ERR_INVALID_PACKAGE_CONFIG = createError("ERR_INVALID_PACKAGE_CONFIG", (e, t, i)=>`Invalid package config ${e}${t ? ` while importing ${t}` : ""}${i ? `. ${i}` : ""}`, Error), eN.ERR_INVALID_PACKAGE_TARGET = createError("ERR_INVALID_PACKAGE_TARGET", (e, t, i, s = !1, r)=>{
            let n = "string" == typeof i && !s && i.length > 0 && !i.startsWith("./");
            return "." === t ? (ek(!1 === s), `Invalid "exports" main target ${JSON.stringify(i)} defined in the package config ${e}package.json${r ? ` imported from ${r}` : ""}${n ? '; targets must start with "./"' : ""}`) : `Invalid "${s ? "imports" : "exports"}" target ${JSON.stringify(i)} defined for '${t}' in the package config ${e}package.json${r ? ` imported from ${r}` : ""}${n ? '; targets must start with "./"' : ""}`;
        }, Error), eN.ERR_MODULE_NOT_FOUND = createError("ERR_MODULE_NOT_FOUND", (e, t, i = !1)=>`Cannot find ${i ? "module" : "package"} '${e}' imported from ${t}`, Error), eN.ERR_NETWORK_IMPORT_DISALLOWED = createError("ERR_NETWORK_IMPORT_DISALLOWED", "import of '%s' by %s is not supported: %s", Error), eN.ERR_PACKAGE_IMPORT_NOT_DEFINED = createError("ERR_PACKAGE_IMPORT_NOT_DEFINED", (e, t, i)=>`Package import specifier "${e}" is not defined${t ? ` in package ${t}package.json` : ""} imported from ${i}`, TypeError), eN.ERR_PACKAGE_PATH_NOT_EXPORTED = createError("ERR_PACKAGE_PATH_NOT_EXPORTED", (e, t, i)=>"." === t ? `No "exports" main defined in ${e}package.json${i ? ` imported from ${i}` : ""}` : `Package subpath '${t}' is not defined by "exports" in ${e}package.json${i ? ` imported from ${i}` : ""}`, Error), eN.ERR_UNSUPPORTED_DIR_IMPORT = createError("ERR_UNSUPPORTED_DIR_IMPORT", "Directory import '%s' is not supported resolving ES modules imported from %s", Error), eN.ERR_UNSUPPORTED_RESOLVE_REQUEST = createError("ERR_UNSUPPORTED_RESOLVE_REQUEST", 'Failed to resolve module specifier "%s" from "%s": Invalid relative URL or base scheme is not hierarchical.', TypeError), eN.ERR_UNKNOWN_FILE_EXTENSION = createError("ERR_UNKNOWN_FILE_EXTENSION", (e, t)=>`Unknown file extension "${e}" for ${t}`, TypeError), eN.ERR_INVALID_ARG_VALUE = createError("ERR_INVALID_ARG_VALUE", (e, t, i = "is invalid")=>{
            let s = (0, eT.inspect)(t);
            s.length > 128 && (s = `${s.slice(0, 128)}...`);
            let r = e.includes(".") ? "property" : "argument";
            return `The ${r} '${e}' ${i}. Received ${s}`;
        }, TypeError);
        let eD = (s = "__node_internal_" + (n = function(t) {
            let i = isErrorStackTraceLimitWritable();
            return i && (e = Error.stackTraceLimit, Error.stackTraceLimit = 1 / 0), Error.captureStackTrace(t), i && (Error.stackTraceLimit = e), t;
        }).name, Object.defineProperty(n, "name", {
            value: s
        }), n);
        function getMessage(e, t, i) {
            let s = eL.get(e);
            if (ek(void 0 !== s, "expected `message` to be found"), "function" == typeof s) return ek(s.length <= t.length, `Code: ${e}; The provided arguments length (${t.length}) does not match the required ones (${s.length}).`), Reflect.apply(s, i, t);
            let r = /%[dfijoOs]/g, n = 0;
            for(; null !== r.exec(s);)n++;
            return (ek(n === t.length, `Code: ${e}; The provided arguments length (${t.length}) does not match the required ones (${n}).`), 0 === t.length) ? s : (t.unshift(s), Reflect.apply(eT.format, null, t));
        }
        function determineSpecificType(e) {
            if (null == e) return String(e);
            if ("function" == typeof e && e.name) return `function ${e.name}`;
            if ("object" == typeof e) return e.constructor && e.constructor.name ? `an instance of ${e.constructor.name}` : `${(0, eT.inspect)(e, {
                depth: -1
            })}`;
            let t = (0, eT.inspect)(e, {
                colors: !1
            });
            return t.length > 28 && (t = `${t.slice(0, 25)}...`), `type ${typeof e} (${t})`;
        }
        let eO = {}.hasOwnProperty, { ERR_INVALID_PACKAGE_CONFIG: eV } = eN, eU = new Map;
        function read(e, { base: t, specifier: i }) {
            let s, r = eU.get(e);
            if (r) return r;
            try {
                s = ef.readFileSync(eC.toNamespacedPath(e), "utf8");
            } catch (e) {
            ...
            if (void 0 !== s) {
                ...
                try {
                    ...
                    let s = new eV(e, (t ? `"${i}" from ` : "") + (0, eE.fileURLToPath)(t || i), r.message);
                    throw s.cause = r, s;
                }
                n.exists = !0, eO.call(r, "name") && "string" == typeof r.name && (n.name = r.name), eO.call(r, "main") && "string" == typeof r.main && (n.main = r.main), eO.call(r, "exports") && (n.exports = r.exports), eO.call(r, "imports") && (n.imports = r.imports), eO.call(r, "type") && ("commonjs" === r.type || "module" === r.type) && (n.type = r.type);
            }
            return eU.set(e, n), n;
        }
        function getPackageScopeConfig(e) {
            ...
            for(; !t.pathname.endsWith("node_modules/package.json");){
                let i = read((0, eE.fileURLToPath)(t), {
                    specifier: e
                });
                if (i.exists) return i;
                let s = t;
                if ((t = new URL("../package.json", t)).pathname === s.pathname) break;
            }
            return {
                pjsonPath: (0, eE.fileURLToPath)(t),
                exists: !1,
                type: "none"
            };
        }
        let { ERR_UNKNOWN_FILE_EXTENSION: eM } = eN, ej = {}.hasOwnProperty, eB = {
            __proto__: null,
            ".cjs": "commonjs",
            ".js": "module",
            ".json": "json",
        ...
        function dist_extname(e) {
            let t = e.pathname, i = t.length;
            for(; i--;){
        ...
        function getFileProtocolModuleFormat(e, t, i) {
            let s = dist_extname(e);
            if (".js" === s) {
                let t = getPackageScopeConfig(e).type;
            ...
            let r = eB[s];
            if (r) return r;
            if (!i) throw new eM(s, (0, eE.fileURLToPath)(e));
        }
        function getHttpProtocolModuleFormat() {}
        function defaultGetFormatWithoutErrors(e, t) {
            let i = e.protocol;
            return ej.call(eF, i) && eF[i](e, t, !0) || null;
        }
        ...
        function emitInvalidSegmentDeprecation(e, t, i, s, r, n, a) {
            ...
            let o = (0, eE.fileURLToPath)(s), h = null !== e4.exec(a ? e : t);
            eS.emitWarning(`Use of deprecated ${h ? "double slash" : "leading or trailing slash matching"} resolving "${e}" for module request "${t}" ${t === i ? "" : `matched to "${i}" `}in the "${r ? "imports" : "exports"}" field module resolution of the package at ${o}${n ? ` imported from ${(0, eE.fileURLToPath)(n)}` : ""}.`, "DeprecationWarning", "DEP0166");
        }
        function emitLegacyIndexDeprecation(e, t, i, s) {
            if (eS.noDeprecation || "module" !== defaultGetFormatWithoutErrors(e, {
                parentURL: i.href
            })) return;
            let r = (0, eE.fileURLToPath)(e.href), n = (0, eE.fileURLToPath)(new eE.URL(".", t)), a = (0, eE.fileURLToPath)(i);
            s ? eC.resolve(n, s) !== r && eS.emitWarning(`Package ${n} has a "main" field set to "${s}", excluding the full filename and extension to the resolved file at "${r.slice(n.length)}", imported from ${a}.
...
Default "index" lookups for the main are deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
        ...
        function tryStatSync(e) {
            try {
                return (0, ef.statSync)(e);
            } catch  {}
        }
        function fileExists(e) {
            let t = (0, ef.statSync)(e, {
                throwIfNoEntry: !1
            }), i = t ? t.isFile() : void 0;
            return null != i && i;
        }
        function legacyMainResolve(e, t, i) {
            let s;
            if (void 0 !== t.main) {
                if (fileExists(s = new eE.URL(t.main, e))) return s;
                let r = [
                    `./${t.main}.js`,
                    `./${t.main}.json`,
                    `./${t.main}.node`,
                ...
                for(; ++n < r.length && !fileExists(s = new eE.URL(r[n], e));)s = void 0;
            ...
            for(; ++n < r.length && !fileExists(s = new eE.URL(r[n], e));)s = void 0;
            if (s) return emitLegacyIndexDeprecation(s, e, i, t.main), s;
            throw new eH((0, eE.fileURLToPath)(new eE.URL(".", e)), (0, eE.fileURLToPath)(i));
        }
        function finalizeResolution(e, t, i) {
            let s;
            if (null !== e2.exec(e.pathname)) throw new eq(e.pathname, 'must not include encoded "/" or "\\" characters', (0, eE.fileURLToPath)(t));
            try {
                s = (0, eE.fileURLToPath)(e);
            } catch (i) {
                throw Object.defineProperty(i, "input", {
                    value: String(e)
                }), Object.defineProperty(i, "module", {
                    value: String(t)
                }), i;
            }
            let r = tryStatSync(s.endsWith("/") ? s.slice(-1) : s);
            if (r && r.isDirectory()) {
                let i = new eZ(s, (0, eE.fileURLToPath)(t));
                throw i.url = String(e), i;
            }
            if (!r || !r.isFile()) {
                let i = new eH(s || e.pathname, t && (0, eE.fileURLToPath)(t), !0);
                throw i.url = String(e), i;
            }
            {
                let t = (0, ef.realpathSync)(s), { search: i, hash: r } = e;
                (e = (0, eE.pathToFileURL)(t + (s.endsWith(eC.sep) ? "/" : ""))).search = i, e.hash = r;
            }
            return e;
        }
        function importNotDefined(e, t, i) {
            return new ez(e, t && (0, eE.fileURLToPath)(new eE.URL(".", t)), (0, eE.fileURLToPath)(i));
        }
        function exportsNotFound(e, t, i) {
            return new eK((0, eE.fileURLToPath)(new eE.URL(".", t)), e, i && (0, eE.fileURLToPath)(i));
        }
        function throwInvalidSubpath(e, t, i, s, r) {
            throw new eq(e, `request is not a valid match in pattern "${t}" for the "${s ? "imports" : "exports"}" resolution of ${(0, eE.fileURLToPath)(i)}`, r && (0, eE.fileURLToPath)(r));
        }
        function invalidPackageTarget(e, t, i, s, r) {
            return t = "object" == typeof t && null !== t ? JSON.stringify(t, null, "") : `${t}`, new eG((0, eE.fileURLToPath)(new eE.URL(".", i)), e, t, s, r && (0, eE.fileURLToPath)(r));
        }
        function resolvePackageTargetString(e, t, i, s, r, n, a, o, h) {
            ...
            if (!e.startsWith("./")) {
                if (a && !e.startsWith("../") && !e.startsWith("/")) {
                    ...
                    if (!i) return packageResolve(n ? e$.call(e0, e, ()=>t) : e + t, s, h);
                }
                throw invalidPackageTarget(i, e, s, a, r);
            }
            if (null !== eQ.exec(e.slice(2))) if (null === eX.exec(e.slice(2))) {
                if (!o) {
                    let o = n ? i.replace("*", ()=>t) : i + t;
                    emitInvalidSegmentDeprecation(n ? e$.call(e0, e, ()=>t) : e, o, i, s, a, r, !0);
                }
            } else throw invalidPackageTarget(i, e, s, a, r);
            let c = new eE.URL(e, s), p = c.pathname, l = new eE.URL(".", s).pathname;
            if (!p.startsWith(l)) throw invalidPackageTarget(i, e, s, a, r);
            if ("" === t) return c;
            if (null !== eQ.exec(t)) {
                let h = n ? i.replace("*", ()=>t) : i + t;
                null === eX.exec(t) ? o || emitInvalidSegmentDeprecation(n ? e$.call(e0, e, ()=>t) : e, h, i, s, a, r, !1) : throwInvalidSubpath(h, i, s, a, r);
            }
            return n ? new eE.URL(e$.call(e0, c.href, ()=>t)) : new eE.URL(t, c);
        }
        function isArrayIndex(e) {
            let t = Number(e);
            return `${t}` === e && t >= 0 && t < 0xffffffff;
        }
        function resolvePackageTarget(e, t, i, s, r, n, a, o, h) {
            ...
            if (Array.isArray(t)) {
                ...
                for(; ++p < t.length;){
                    let l, u = t[p];
                    try {
                        l = resolvePackageTarget(e, u, i, s, r, n, a, o, h);
                    } catch (e) {
            ...
            if ("object" == typeof t && null !== t) {
                ...
                for(; ++p < c.length;)if (isArrayIndex(c[p])) throw new eW((0, eE.fileURLToPath)(e), r, '"exports" cannot contain numeric property keys.');
                for(p = -1; ++p < c.length;){
                    let l = c[p];
                    if ("default" === l || h && h.has(l)) {
                        let c = resolvePackageTarget(e, t[l], i, s, r, n, a, o, h);
        ...
        function isConditionalExportsMainSugar(e, t, i) {
            if ("string" == typeof e || Array.isArray(e)) return !0;
            if ("object" != typeof e || null === e) return !1;
            let s = Object.getOwnPropertyNames(e), r = !1, n = 0, a = -1;
            for(; ++a < s.length;){
                let e = s[a], o = "" === e || "." !== e[0];
                if (0 == n++) r = o;
                else if (r !== o) throw new eW((0, eE.fileURLToPath)(t), i, "\"exports\" cannot contain some keys starting with '.' and some not. The exports object must either be an object of package subpath keys or an object of main entry condition name keys only.");
            }
            return r;
        }
        function emitTrailingSlashPatternDeprecation(e, t, i) {
            if (eS.noDeprecation) return;
            let s = (0, eE.fileURLToPath)(t);
            e3.has(s + "|" + e) || (e3.add(s + "|" + e), eS.emitWarning(`Use of deprecated trailing slash pattern mapping "${e}" in the "exports" field module resolution of the package at ${s}${i ? ` imported from ${(0, eE.fileURLToPath)(i)}` : ""}. Mapping specifiers ending in "/" is no longer supported.`, "DeprecationWarning", "DEP0155"));
        }
        function packageExportsResolve(e, t, i, s, r) {
            let n = i.exports;
            if (isConditionalExportsMainSugar(n, e, s) && (n = {
                ".": n
            }), eY.call(n, t) && !t.includes("*") && !t.endsWith("/")) {
                let i = resolvePackageTarget(e, n[t], "", t, s, !1, !1, !1, r);
                if (null == i) throw exportsNotFound(t, e, s);
                return i;
            }
            let a = "", o = "", h = Object.getOwnPropertyNames(n), c = -1;
            for(; ++c < h.length;){
                let i = h[c], r = i.indexOf("*");
            ...
            if (a) {
                let i = resolvePackageTarget(e, n[a], o, a, s, !0, !1, t.endsWith("/"), r);
                if (null == i) throw exportsNotFound(t, e, s);
                return i;
            }
        ...
        function patternKeyCompare(e, t) {
            let i = e.indexOf("*"), s = t.indexOf("*"), r = -1 === i ? e.length : i + 1, n = -1 === s ? t.length : s + 1;
            return r > n ? -1 : n > r || -1 === i ? 1 : -1 === s || e.length > t.length ? -1 : +(t.length > e.length);
        }
        function packageImportsResolve(e, t, i) {
            let s;
            if ("#" === e || e.startsWith("#/") || e.endsWith("/")) throw new eq(e, "is not a valid internal imports specifier name", (0, eE.fileURLToPath)(t));
            let r = getPackageScopeConfig(t);
            if (r.exists) {
                s = (0, eE.pathToFileURL)(r.pjsonPath);
                let n = r.imports;
                if (n) if (eY.call(n, e) && !e.includes("*")) {
                    let r = resolvePackageTarget(s, n[e], "", e, t, !1, !0, !1, i);
                    if (null != r) return r;
                } else {
                    let r = "", a = "", o = Object.getOwnPropertyNames(n), h = -1;
                    for(; ++h < o.length;){
                        let t = o[h], i = t.indexOf("*");
                    ...
                    if (r) {
                        let e = resolvePackageTarget(s, n[r], a, r, t, !0, !0, !1, i);
                        if (null != e) return e;
                    }
                }
            }
            throw importNotDefined(e, s, t);
        }
        function parsePackageName(e, t) {
            let i = e.indexOf("/"), s = !0, r = !1;
            "@" === e[0] && (r = !0, -1 === i || 0 === e.length ? s = !1 : i = e.indexOf("/", i + 1));
            let n = -1 === i ? e : e.slice(0, i);
            if (null !== e1.exec(n) && (s = !1), !s) throw new eq(e, "is not a valid package name", (0, eE.fileURLToPath)(t));
            return {
                packageName: n,
        ...
        function packageResolve(e, t, i) {
            let s;
            if (ed.builtinModules.includes(e)) return new eE.URL("node:" + e);
            let { packageName: r, packageSubpath: n, isScoped: a } = parsePackageName(e, t), o = getPackageScopeConfig(t);
            if (o.exists) {
                let e = (0, eE.pathToFileURL)(o.pjsonPath);
                if (o.name === r && void 0 !== o.exports && null !== o.exports) return packageExportsResolve(e, n, o, t, i);
            }
            let h = new eE.URL("./node_modules/" + r + "/package.json", t), c = (0, eE.fileURLToPath)(h);
            do {
                let o = tryStatSync(c.slice(0, -13));
                if (!o || !o.isDirectory()) {
                    s = c, h = new eE.URL((a ? "../../../../node_modules/" : "../../../node_modules/") + r + "/package.json", h), c = (0, eE.fileURLToPath)(h);
                    continue;
                }
                let p = read(c, {
                    base: t,
                ...
                if (void 0 !== p.exports && null !== p.exports) return packageExportsResolve(h, n, p, t, i);
                if ("." === n) return legacyMainResolve(h, p, t);
                return new eE.URL(n, h);
            }while (c.length !== s.length)
            throw new eH(r, (0, eE.fileURLToPath)(t), !1);
        }
        function isRelativeSpecifier(e) {
            return "." === e[0] && (1 === e.length || "/" === e[1] || "." === e[1] && (2 === e.length || "/" === e[2])) || !1;
        }
        ...
        function moduleResolve(e, t, i, s) {
            ...
            else if ("file:" === n && "#" === e[0]) r = packageImportsResolve(e, t, i);
            else try {
                r = new eE.URL(e);
            } catch (s) {
                if (("data:" === n || "http:" === n || "https:" === n) && !ed.builtinModules.includes(e)) {
                    let i = new eJ(e, t);
                    throw i.cause = s, i;
                }
                r = packageResolve(e, t, i);
            }
            return (ek(void 0 !== r, "expected to be defined"), "file:" !== r.protocol) ? r : finalizeResolution(r, t);
        }
        function fileURLToPath(e) {
            return "string" != typeof e || e.startsWith("file://") ? normalizeSlash((0, eE.fileURLToPath)(e)) : normalizeSlash(e);
        }
        function pathToFileURL(e) {
            return (0, eE.pathToFileURL)(fileURLToPath(e)).toString();
        }
        function normalizeid(e) {
            return ("string" != typeof e && (e = e.toString()), /(?:node|data|http|https|file):/.test(e)) ? e : eI.has(e) ? "node:" + e : "file://" + encodeURI(normalizeSlash(e));
        }
        let e6 = new Set([
            "node",
            "import"
        ...
        function _tryModuleResolve(e, t, i) {
            try {
                ...
                if (!e9.has(e?.code)) throw e;
            }
        }
        function _resolve(e, t = {}) {
            let i;
            if ("string" != typeof e) if (e instanceof URL) e = fileURLToPath(e);
            else throw TypeError("input must be a `string` or `URL`");
            if (/(?:node|data|http|https):/.test(e)) return e;
            if (eI.has(e)) return "node:" + e;
            if (e.startsWith("file://") && (e = fileURLToPath(e)), isAbsolute(e)) try {
                if ((0, ef.statSync)(e).isFile()) return pathToFileURL(e);
            } catch (e) {
                if (e?.code !== "ENOENT") throw e;
            }
            let s = t.conditions ? new Set(t.conditions) : e6, r = (Array.isArray(t.url) ? t.url : [
                t.url
            ]).filter(Boolean).map((e)=>new URL(normalizeid(e.toString())));
            0 === r.length && r.push(new URL(pathToFileURL(process.cwd())));
            let n = [
                ...r
            ];
            for (let e of r)"file:" === e.protocol && n.push(new URL("./", e), new URL(dist_joinURL(e.pathname, "_index.js"), e), new URL("node_modules", e));
            for (let r of n){
                if (i = _tryModuleResolve(e, r, s)) break;
                for (let n of [
                    "",
                    "/index"
                ]){
                    for (let a of t.extensions || e5)if (i = _tryModuleResolve(dist_joinURL(e, n) + a, r, s)) break;
                    if (i) break;
                }
                if (i) break;
            }
            if (!i) {
                let t = Error(`Cannot find module ${e} imported from ${n.join(", ")}`);
                throw t.code = "ERR_MODULE_NOT_FOUND", t;
            }
            return pathToFileURL(i);
        }
        ...
        function hasESMSyntax(e, t = {}) {
            return t.stripComments && (e = e.replace(e7, "")), e8.test(e);
        }
        ...
        let te = new Set([
            ...
            "\\",
            void 0
        ]), tt = Symbol.for("pathe:normalizedAlias"), ti = /[/\\]/;
        function normalizeAliases(e) {
            if (e[tt]) return e;
            let t = Object.fromEntries(Object.entries(e).sort(([e], [t])=>_compareAliases(e, t)));
            for(let e in t)for(let i in t)!(i === e || e.startsWith(i)) && t[e]?.startsWith(i) && te.has(t[e][i.length]) && (t[e] = t[i] + t[e].slice(i.length));
            return Object.defineProperty(t, tt, {
                value: !0,
                enumerable: !1
            }), t;
        }
        function resolveAlias(e, t) {
            let i = pathe_M_eThtNZ_normalizeWindowsPath(e);
            for (let [e, s] of Object.entries(t = normalizeAliases(t))){
                if (!i.startsWith(e)) continue;
                let t = utils_hasTrailingSlash(e) ? e.slice(0, -1) : e;
                if (utils_hasTrailingSlash(i[t.length])) return pathe_M_eThtNZ_join(s, i.slice(e.length));
            }
            return i;
        }
        function utils_filename(e) {
            let t = e.split(ti).pop();
            if (!t) return;
            let i = t.lastIndexOf(".");
            return i <= 0 ? t : t.slice(0, i);
        }
        function _compareAliases(e, t) {
        ...
        let ts = __turbopack_context__.r("[externals]/node:crypto [external] (node:crypto, cjs)");
        var tr = __webpack_require__.n(ts);
        let tn = Object.create(null), dist_i = (e)=>globalThis.process?.env || globalThis.Deno?.env.toObject() || globalThis.__env__ || (e ? tn : globalThis), ta = new Proxy(tn, {
            get: (e, t)=>dist_i()[t] ?? tn[t],
            has: (e, t)=>t in dist_i() || t in tn,
            ...
            ownKeys: ()=>Object.keys(dist_i(!0))
        }), to = "u" > typeof process && process.env && process.env.NODE_ENV || "", th = [
            [
                "APPVEYOR"
            ],
            [
            ...
            if (globalThis.process?.env) for (let e of th){
                let t = e[1] || e[0];
        ...
        tb?.name;
        let tE = __turbopack_context__.r("[externals]/node:tty [external] (node:tty, cjs)"), tk = tE?.WriteStream?.prototype?.hasColors?.() ?? !1, base_format = (e, t)=>{
            if (!tk) return (e)=>e;
            let i = `\u001B[${e}m`, s = `\u001B[${t}m`;
            return (e)=>{
                let r = e + "", n = r.indexOf(s);
                if (-1 === n) return i + r + s;
                let a = i, o = 0, h = (22 === t ? s : "") + i;
                for(; -1 !== n;)a += r.slice(o, n) + h, o = n + s.length, n = r.indexOf(s, o);
                return a + (r.slice(o) + s);
            };
        };
        ...
        function isDir(e) {
            ...
            try {
                return (0, ef.lstatSync)(e).isDirectory();
            } catch  {
                return !1;
            }
        }
        function isWritable(e) {
            try {
                return (0, ef.accessSync)(e, ef.constants.W_OK), !0;
            } catch  {
                return !1;
            }
        }
        function utils_hash(e, t = 8) {
            return (isFipsMode() ? tr().createHash("sha256") : tr().createHash("md5")).update(e).digest("hex").slice(0, t);
        }
        function readNearestPackageJSON(e) {
            for(; e && "." !== e && "/" !== e;){
                e = pathe_M_eThtNZ_join(e, "..");
                try {
                    let t = (0, ef.readFileSync)(pathe_M_eThtNZ_join(e, "package.json"), "utf8");
                    try {
                        return JSON.parse(t);
                    } catch  {}
                    break;
        ...
        function debug(e, ...t) {
            ...
            console.log(tR([
                "[jiti]",
                ...t.map((e)=>e in tP ? tP[e] : "string" != typeof e ? JSON.stringify(e) : e.replace(i, "."))
            ].join(" ")));
        }
        function jitiInteropDefault(e, t) {
            return e.opts.interopDefault ? utils_interopDefault(t) : t;
        }
        function utils_interopDefault(e) {
            let t = typeof e;
            if (null === e || "object" !== t && "function" !== t) return e;
            let i = e.default, s = typeof i, r = null == i, n = "object" === s || "function" === s;
            return r && e instanceof Promise ? e : new Proxy(e, {
                get (t, s, a) {
        ...
        function normalizeWindowsImportId(e) {
            return tu && isAbsolute(e) ? pathToFileURL(e) : e;
        }
        function isFipsMode() {
        ...
        function jitiResolve(e, t, i) {
            ...
            e.alias && (t = resolveAlias(t, e.alias));
            let n = i?.parentURL || e.url;
            for (let a of (isDir(n) && (n = pathe_M_eThtNZ_join(n, "_index.js")), (i?.async ? [
                i?.conditions,
                [
                    "node",
                    "import"
            ...
            for (let r of e.additionalExts)if ((s = tryNativeRequireResolve(e, t + r, n, i) || tryNativeRequireResolve(e, t + "/index" + r, n, i)) || (tN.test(e.filename) || tN.test(e.parentModule?.filename || "") || tA.test(t)) && (s = tryNativeRequireResolve(e, t.replace(tA, ".$1t$2"), n, i))) return s;
            if (!i?.try) throw r;
        }
        ...
        let tL = __turbopack_context__.r("[externals]/node:perf_hooks [external] (node:perf_hooks, cjs)"), tD = __turbopack_context__.r("[externals]/node:vm [external] (node:vm, cjs)");
        var tO = __webpack_require__.n(tD);
        function jitiRequire(e, t, i) {
            let s = e.parentCache || {};
            if (t.startsWith("node:")) return nativeImportOrRequire(e, t, i.async);
            if (t.startsWith("file:")) t = (0, eE.fileURLToPath)(t);
            else if (t.startsWith("data:")) {
                if (!i.async) throw Error("`data:` URLs are only supported in ESM context. Use `import` or `jiti.import` instead.");
                return debug(e, "[native]", "[data]", "[import]", t), nativeImportOrRequire(e, t, !0);
            }
            if (ed.builtinModules.includes(t) || ".pnp.js" === t) return nativeImportOrRequire(e, t, i.async);
            ...
            let r = jitiResolve(e, t, i);
            if (!r && i.try) return;
            let n = extname(r);
            if (".json" === n) {
                debug(e, "[json]", r);
                let t = e.nativeRequire(r);
            ...
            if (e.opts.moduleCache) {
                let t = e.nativeRequire.cache[r];
                if (t?.loaded) return jitiInteropDefault(e, t.exports);
            }
            return eval_evalModule(e, (0, ef.readFileSync)(r, "utf8"), {
                id: t,
                filename: r,
                ext: n,
                cache: s,
        ...
        function nativeImportOrRequire(e, t, i) {
            return i && e.nativeImport ? e.nativeImport(normalizeWindowsImportId(t)).then((t)=>jitiInteropDefault(e, t)) : jitiInteropDefault(e, e.nativeRequire(t));
        }
        function getCache(e, t, i) {
            if (!e.opts.fsCache || !t.filename) return i();
            let s = ` /* v9-${utils_hash(t.source, 16)} */
`, r = `${basename(pathe_M_eThtNZ_dirname(t.filename))}-${utils_filename(t.filename)}` + (e.opts.sourceMaps ? "+map" : "") + (t.interopDefault ? ".i" : "") + `.${utils_hash(t.filename)}` + (t.async ? ".mjs" : ".cjs");
            t.jsx && t.filename.endsWith("x") && (r += "x");
            let n = pathe_M_eThtNZ_join(e.opts.fsCache, r);
            if (!e.opts.rebuildFsCache && (0, ef.existsSync)(n)) {
                let i = (0, ef.readFileSync)(n, "utf8");
                if (i.endsWith(s)) return debug(e, "[cache]", "[hit]", t.filename, "~>", n), i;
            }
            debug(e, "[cache]", "[miss]", t.filename);
            let a = i();
            return a.includes("__JITI_ERROR__") || ((0, ef.writeFileSync)(n, a + s, "utf8"), debug(e, "[cache]", "[store]", t.filename, "~>", n)), a;
        }
        function prepareCacheDir(e) {
            if (!0 === e.opts.fsCache && (e.opts.fsCache = getCacheDir(e)), e.opts.fsCache) try {
                if ((0, ef.mkdirSync)(e.opts.fsCache, {
                    recursive: !0
                }), !isWritable(e.opts.fsCache)) throw Error("directory is not writable!");
            } catch (t) {
                debug(e, "Error creating cache directory at ", e.opts.fsCache, t), e.opts.fsCache = !1;
            }
        }
        function getCacheDir(e) {
            let t = e.filename && pathe_M_eThtNZ_resolve(e.filename, "../node_modules");
            if (t && (0, ef.existsSync)(t)) return pathe_M_eThtNZ_join(t, ".cache/jiti");
            let i = (0, r.tmpdir)();
            if (process.env.TMPDIR && i === process.cwd() && !process.env.JITI_RESPECT_TMPDIR_ENV) {
                let e = process.env.TMPDIR;
                delete process.env.TMPDIR, i = (0, r.tmpdir)(), process.env.TMPDIR = e;
            }
            return pathe_M_eThtNZ_join(i, "jiti");
        }
        function transform(e, t) {
            let i = getCache(e, t, ()=>{
                let i = e.opts.transform({
        ...
        function eval_evalModule(e, t, i = {}) {
            let s, r, n = i.id || (i.filename ? basename(i.filename) : `_jitiEval.${i.ext || (i.async ? "mjs" : "js")}`), a = i.filename || jitiResolve(e, n, {
                async: i.async
            }), o = i.ext || extname(a), h = i.cache || e.parentCache || {}, c = /\.[cm]?tsx?$/.test(o), p = ".mjs" === o || ".js" === o && readNearestPackageJSON(a)?.type === "module", l = ".cjs" === o, u = i.forceTranspile ?? (!l && !(p && i.async) && (c || p || e.isTransformRe.test(a) || hasESMSyntax(t))), d = tL.performance.now();
            if (u) {
                t = transform(e, {
                    filename: a,
                    source: t,
                ...
                let s = Math.round((tL.performance.now() - d) * 1e3) / 1e3;
                debug(e, "[transpile]", i.async ? "[esm]" : "[cjs]", a, `(${s}ms)`);
            } else {
                if (debug(e, "[native]", i.async ? "[import]" : "[require]", a), i.async) return Promise.resolve(nativeImportOrRequire(e, a, i.async)).catch((s)=>(debug(e, "Native import error:", s), debug(e, "[fallback]", a), eval_evalModule(e, t, {
                        ...i,
                        forceTranspile: !0
                    })));
                try {
                    return nativeImportOrRequire(e, a, i.async);
                } catch (s) {
                    debug(e, "Native require error:", s), debug(e, "[fallback]", a), t = transform(e, {
                        filename: a,
                        source: t,
                        ts: c,
                        async: i.async ?? !1,
            ...
            let f = new ed.Module(a);
            f.filename = a, e.parentModule && (f.parent = e.parentModule, Array.isArray(e.parentModule.children) && !e.parentModule.children.includes(f) && e.parentModule.children.push(f));
            let m = createJiti(a, e.opts, {
                parentModule: f,
                parentCache: h,
            ...
            f.require = m, f.path = pathe_M_eThtNZ_dirname(a), f.paths = ed.Module._nodeModulePaths(f.path), h[a] = f, e.opts.moduleCache && (e.nativeRequire.cache[a] = f);
            let g = wrapModule(t, {
                async: i.async
            });
            try {
                s = tO().runInThisContext(g, {
                    filename: a,
                    lineOffset: 0,
                    displayErrors: !1
                });
            } catch (t) {
                "SyntaxError" === t.name && i.async && e.nativeImport ? (debug(e, "[esm]", "[import]", "[fallback]", a), s = esmEval(g, e.nativeImport)) : (e.opts.moduleCache && delete e.nativeRequire.cache[a], e.onError(t));
            }
            try {
                r = s(f.exports, f.require, f, f.filename, pathe_M_eThtNZ_dirname(f.filename), m.import, m.esmResolve);
            } catch (t) {
                e.opts.moduleCache && delete e.nativeRequire.cache[a], e.onError(t);
            }
            function next() {
                if (f.exports && f.exports.__JITI_ERROR__) {
                    let { filename: t, line: i, column: s, code: r, message: n } = f.exports.__JITI_ERROR__, a = `${t}:${i}:${s}`, o = Error(`${r}: ${n} 
 ${a}`);
                    Error.captureStackTrace(o, jitiRequire), e.onError(o);
                }
                return f.loaded = !0, jitiInteropDefault(e, f.exports);
            }
            return i.async ? Promise.resolve(r).then(next) : next();
        }
        function esmEval(e, t) {
            let i = `data:text/javascript;base64,${Buffer.from(`export default ${e}`).toString("base64")}`;
            return (...e)=>t(i).then((t)=>t.default(...e));
        }
        let tV = "win32" === (0, r.platform)();
        function createJiti(e, t = {}, i, s = !1) {
            let r = s ? t : resolveJitiOptions(t), n = r.alias && Object.keys(r.alias).length > 0 ? normalizeAliases(r.alias || {}) : void 0, a = [
                "typescript",
                "jiti",
                ...r.nativeModules || []
            ], o = RegExp(`node_modules/(${a.map((e)=>escapeStringRegexp(e)).join("|")})/`), h = [
                ...r.transformModules || []
            ], c = RegExp(`node_modules/(${h.map((e)=>escapeStringRegexp(e)).join("|")})/`);
            e || (e = process.cwd()), !s && isDir(e) && (e = pathe_M_eThtNZ_join(e, "_index.js"));
            let p = pathToFileURL(e), l = [
                ...r.extensions
            ...
            ].flat()), s || prepareCacheDir(d), Object.assign(function(e) {
...
function lazyTransform(...args) {
    if (!_transform) {
        _transform = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$module__$5b$external$5d$__$28$node$3a$module$2c$__cjs$29$__["createRequire"])(__TURBOPACK__import$2e$meta__.url)("../dist/babel.cjs");
    }
...
//# sourceMappingURL=node_modules_jiti_30d07a2a._.js.map